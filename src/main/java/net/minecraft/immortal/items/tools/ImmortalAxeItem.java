...
public class ImmortalAxeItem extends ImmortalMiningToolItem {
    protected static final Map<Block, Block> STRIPPED_BLOCKS;

    protected ImmortalAxeItem(ToolMaterial material, float attackDamage, float attackSpeed, Item.Settings settings) {
